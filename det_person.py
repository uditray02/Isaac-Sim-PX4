...
class YoloROS2(Node):
    ...
    def __init__(self):
        super().__init__('yolo_ros2_person_node')
        ...
        self.classes = [0]          # 🔒 PERSON ONLY (COCO class 0)
        self.agnostic_nms = False

        # ---------------- DEVICE ----------------
        self.device = select_device("0")  # GPU 0
        ...
        self.get_logger().info("YOLOv5 PERSON-ONLY node started")
    ...
    def image_callback(self, msg):
        ...
        cv2.imshow("V11-Kamikaze | PERSON DETECTION", img0)
        cv2.waitKey(1)
